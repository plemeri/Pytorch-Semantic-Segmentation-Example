...
class AtrousSpatialPyramidPooling(nn.Module):
    ...
    def forward(self, x):
        ...
        feature5 = F.interpolate(feature5, feature1.size()[-2:], mode='bilinear', align_corners=True)
...
class DeepLab(nn.Module):
    ...
    def forward(self, input, label=None):
        ...
        out = F.interpolate(out, size=low_level_feature.size()[-2:], mode='bilinear', align_corners=True)
